							...
							<table
								...
								<tr height="62px">
									<td colspan=7 align=center><a class="yellowLabel"
										...
										href="followrequests"><titleSelected>requests</titleSelected></a></td>
								</tr>
								<tr height="5px">
									<td></td>
									<td></td>
								...
								<tr>
									<td colspan="7" align="center" valign="top" height="290px">
										...
										<div id="followrequestsContent">
											<table background="img/asphalt.jpg">
												<tr height=20px>
													<td align=center><contentlabels>requests:
														${followrequests}</contentlabels></td>
												</tr>
												<tr>
													<td align=center>
														<div>
															<ul>
																<c:forEach items="${followrequestsNames}"
																	var="followrequestsNames">
																	<li><a
																		href="followrequests?showUser=${followrequestsNames}">${followrequestsNames}</a>
																		<input type="button" value="Y"
																		onclick="window.location.href='followrequests?requestapprove=${followrequestsNames}'">
																		<input type="button" value="N"
																		onclick="window.location.href='followrequests?requestdeny=${followrequestsNames}'"></li>
																</c:forEach>
															</ul>
														</div>
													</td>
											...
											<table height="80px" cellpadding="0" cellspacing="0">
												...
												<tr>
													<td colspan=3 align=center><input type="button"
														value="${followStat}"
														onclick="window.location.href='followrequests?${followStat}=${usernameSelected}'">&nbsp;&nbsp;<input
...
<script>
	...
	if (showVal == 'true') {
	    document.getElementById('followrequestsContent').style.display = 'none'; //Will hide search input
	    document.getElementById('selectedUser').style.display = 'block'; //Will show
	} else {
	    document.getElementById('followrequestsContent').style.display = 'block'; //Will show
