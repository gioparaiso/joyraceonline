...
<body bgcolor="#7f7f7f">
	...
	<form name="configForm" method="post" action="configsuperuser">
						...
						<tr>
							...
							<td>
								<table
									...
									<!-- super user name -->
									<tr height="62px">
										<td colspan=7 align=center><login>super user
											config</login></td>
									</tr>
									<tr height="5px">
										<td></td>
									...
									<tr height=30px>
										...
										<td></td>
										<td colspan=3 align=left><input type="text" id="superusername"
											name="superusername" size=15 value="${superusername}" /></td>
									</tr>
									<tr height=30px>
										<td colspan=3 align=right><contentlabels>change
