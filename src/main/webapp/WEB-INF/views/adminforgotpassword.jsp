...
<body bgcolor="#7f7f7f" height="100%">
	...
	<form name="forgotPasswdForm" method="post"
		action="adminforgotpassword">
						...
						<tr>
							...
							<td>
								...
								<table style="width: 100%; height: 100%" cellpadding="0"
									...
									<tr height="100px">
										<td colspan=5 align=center><login>Forgot Password</login></td>
									</tr>
									<tr height="1px">
										<td width="30px"></td>
										<td></td>
									...
									<!-- error message -->
									<tr height="20px">
										<td colspan="5" align=center><errorMessage>${forgotpasswordError}</errorMessage></td>
									</tr>
									<tr height="20px">
										<td colspan="5"></td>
									</tr>
									<tr height="30px">
										...
										<td></td>
										<td><input type="text" name="adminname" size="20"
											value="${adminname}" /></td>
										<td></td>
									</tr>
									<tr height="40px">
										...
										<td colspan=4 align=right valign=bottom><input
											type="submit" value=" Email me new password " /></td>
										<td></td>
									</tr>
									<tr>
										<td colspan=5></td>
