							...
							<table
								...
								<tr height="62px">
									<td colspan=7 align=center><a class="yellowLabel"
										...
										href="following"><titleSelected>following</titleSelected></a>&nbsp;&nbsp;&nbsp;&nbsp;<a
									...
									<td colspan="7" align="center" valign="top" height="290px">
										...
										<div id="followingContent">
											<table background="img/asphalt.jpg">
												<tr height=20px>
													<td align=center><contentlabels>following:
														${following}</contentlabels></td>
												</tr>
												<tr>
													<td align=center>
														<div>
															<ul>
																<c:forEach items="${followingNames}"
																	var="followingNames">
																	<li><center>
																			<a href="following?showUser=${followingNames}">${followingNames}</a>
																		</center></li>
																</c:forEach>
															</ul>
														</div>
											...
											<table height="80px" cellpadding="0" cellspacing="0">
												...
												<tr>
													<td colspan=3 align=center><input type="button"
														value="${followStat}"
														onclick="window.location.href='following?${followStat}=${usernameSelected}'">&nbsp;&nbsp;<input
...
<script>
	...
	if (showVal == 'true') {
	    document.getElementById('followingContent').style.display = 'none'; //Will hide search input
	    document.getElementById('selectedUser').style.display = 'block'; //Will show
	} else {
	    document.getElementById('followingContent').style.display = 'block'; //Will show
